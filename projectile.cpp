...
//checks if time is positive and prints a statement and ends the program if its negative
	if (time < 0){
	...
	float vy = initVel * sin(initAng); //converts scalar velocity to vertical component
...
//prints acending or decending and above or below initial position based on the vertical velocity and position
	if (vy >= 0){
